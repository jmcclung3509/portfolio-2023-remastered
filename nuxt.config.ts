  ...
  app: {
    head: {
      ...
      link: [
        ...
        {
          href: "https://fonts.googleapis.com/css2?family=Dancing+Script:wght@700&family=Playfair:opsz@5..1200&family=Roboto:wght@100;300&family=Work+Sans:wght@300&display=swap",
          rel: "stylesheet"
        },
