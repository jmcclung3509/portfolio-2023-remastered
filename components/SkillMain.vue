<template>
	<div class="container mx-auto flex flex-col items-start space-y-14">
		<h2 class="text-2xl text-default-dark">Experience & Skills</h2>
		<div class="menu flex justify-start gap-14 pb-7">
			<h3
				class="text-1.2xl text-default-dark"
		...
		<div class="contents w-full">
								...
								<div class="bullet-section">
									<ul class="flex flex-row flex-wrap items-start w-[110%] custom">
										<li class="w-1/2 pb-14 ">
											<h3 class="text-default-dark">Experience</h3>
											<p class="text-default-dark ml-[40px]"> 2+ years</p>
										</li>
										<li class="pb-14 ">
											<h3 class="text-default-dark">Location</h3>
												<p class="text-default-dark ml-[40px]"> Bay Area, CA</p>
										</li>
										<li class="w-1/2 ">
											<h3 class="text-default-dark">Hobbies</h3>
												<p class="text-default-dark ml-[40px]">			Reading, baking, crafting, card games (esp. UNO)</p>
										</li>
									</ul>
								</div>
			...
			<template v-if="data.selectedSection === 'skills'">
				<div id="skills"
								...
								<p class="text-default-dark text-fine  pb-7">
								...
								<div class="bullet-section">
									<ul class="flex tems-start flex-row flex-wrap w-[120%] custom ">
										<li class="w-1/2 pb-14 pr-7">
											<h3 class="text-default-dark">html/css</h3>
											<p class="text-default-dark ml-[40px]"> SCSS, Sass, Flex, Grid, Bootstrap, Tailwind</p>
										</li>
										<li class="w-1/2 pb-14 pr-7 ">
											<h3 class="text-default-dark">design</h3>
											<p class="text-default-dark ml-[40px]">Wireframing, prototyping, Adobe Creative Suite, Figma</p>
										</li>
										<li class="w-1/2 pb-14 pr-7 ">
											<h3 class="text-default-dark">Development</h3>
												<p class="text-default-dark ml-[40px]"> JavaScript(ES6+), API, Vue, Nuxt, WordPress</p>
										</li>
										<li class="w-1/2 pb-14 pr-7">
											<h3 class="text-default-dark">Tools</h3>
												<p class="text-default-dark ml-[40px]">Git/GitHub, Sourcetree, Azure, Chrome DevTools, FTP Client, Postman, MongoDB</p>
										</li>
										<li class="w-1/2 pb-14 ">
											<h3 class="text-default-dark">Soft skills</h3>
												<p class="text-default-dark ml-[40px] w-4/5">Creative problem solver, growth-mindset, can-do attitude, skilled communicator, self-starter, excellent time-management.</p>
										</li>
									</ul>
								</div>
							</div>
								...
								<div class="bullet-section">
									<ul class="flex items-start flex-row flex-wrap w-[110%] custom">
										<li class=" w-4/5 pb-14 space-y-1">
											<h3 class="text-default-dark ">Sitezeus</h3>
											<p class="text-default-dark ml-[40px]"> Junior Frontend Developer, September 2022-Present</p>
											<p class="text-default-dark ml-[40px]"> Vue, Nuxt, WordPress</p>
										...
										<li class="w-4/5 pb-14 space-y-1">
											...
											<h3 class="text-default-dark ">Freelance</h3>
											<p class="text-default-dark ml-[40px]">Frontend Developer, UI/UX Designer, April 2021 - Present</p>

											<p class="text-default-dark ml-[40px]">React, Vue, Nuxt, Adobe Creative Suite, Figma</p>
