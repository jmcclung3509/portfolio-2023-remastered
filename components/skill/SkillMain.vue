	...
	<div class="container mx-auto flex flex-col items-start space-y-14">
		...
		<div class="contents w-full">
			<template v-if="data.selectedSection === 'about'">
						...
						<div id="about" class="flex items-start lg:flex-row justify-center flex-col space-y-14 lg:space-y-0">
							<div
								class="flex flex-col w-full lg:w-1/2 items-start space-y-14">
								<div class="content space-y-7">
								<p class="text-dark-purple text-fine">
								...
								<div class="bullet-section">
									<ul class="flex flex-row flex-wrap items-start w-[110%] custom">
										<li class="w-1/2 pb-14 ">
											<h3 class="text-dark-purple font-medium">Experience</h3>
											<p class="text-dark-purple ml-[40px]"> 2+ years</p>
										</li>
										<li class="pb-14 ">
											<h3 class="text-dark-purple font-medium">Location</h3>
												<p class="text-dark-purple ml-[40px]"> Bay Area, CA</p>
										</li>
										<li class="w-1/2 ">
											<h3 class="text-dark-purple font-medium">Hobbies</h3>
			...
			<template v-if="data.selectedSection === 'skills'">
				<div id="skills"
								class="flex flex-col lg:w-3/4  w-full items-start space-y-14">
								<div class="content space-y-7">
								<p class="text-dark-purple text-fine">
								...
								<div class="bullet-section">
									<ul class="flex items-start flex-row flex-wrap w-[120%] custom ">
										<li class="w-2/3 lg:w-1/2 pb-14 pr-7">
											<h3 class="text-dark-purple font-medium">html/css</h3>
											<p class="text-dark-purple ml-[40px]"> SCSS, Sass, Flex, Grid, Bootstrap, Tailwind</p>
										</li>
										<li class="w-2/3 lg:w-1/2 pb-14 pr-7 ">
											<h3 class="text-dark-purple font-medium">design</h3>
											<p class="text-dark-purple ml-[40px]">Wireframing, prototyping, Adobe Creative Suite, Figma</p>
										</li>
										<li class="w-2/3 lg:w-1/2 pb-14 pr-7 ">
											<h3 class="text-dark-purple font-medium">Development</h3>
												<p class="text-dark-purple ml-[40px]"> JavaScript(ES6+), API, Vue, Nuxt, WordPress</p>
										</li>
										<li class="w-2/3 lg:w-1/2 pb-14 pr-7">
											<h3 class="text-dark-purple font-medium">Tools</h3>
												<p class="text-dark-purple ml-[40px]">Git/GitHub, Sourcetree, Azure, Chrome DevTools, FTP Client, Postman, MongoDB</p>
										</li>
										<li class="w-2/3 lg:w-1/2 pb-14 ">
											<h3 class="text-dark-purple font-medium">Soft skills</h3>
				...
				<div
								class="flex flex-col w-full lg:w-3/4 items-start space-y-14">
								<div class="content space-y-7">
								<p class="text-dark-purple text-fine">
								...
								<div class="bullet-section">
									<ul class="flex items-start flex-row flex-wrap w-[110%] custom">
										...
										<li class="w-4/5 pb-14 space-y-1">
											...
											<p class="text-orange font-light ml-[40px]">Frontend Developer, UI/UX Designer, April 2021 - Present</p>

											<p class="text-orange ml-[40px]">React, Vue, Nuxt, Adobe Creative Suite, Figma</p>
											<p class="text-dark-purple pt-4 ml-[40px]"> Design, develop and maintain several websites for various clients. </p>
										</li>
